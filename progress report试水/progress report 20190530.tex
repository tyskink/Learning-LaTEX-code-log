...
\usepackage{url}	%for online bib resources
\begin{document}
%% ---------------------------------------------------------------- Top Matter
\frontmatter 
%frontmatter: turns off chapter numbering and uses roman numerals for page numbers  from <ecsprogress> or <book>
...
%% ---------------------------------------------------------------- Main Body
\mainmatter
%mainmatter: turns on chapter numbering, resets page numbering and uses arabic numerals for page numbers; from <ecsprogress> or <book>
